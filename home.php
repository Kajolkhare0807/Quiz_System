...
<html>
   ...
   <body>
      ...
      <div>
         ...
         <h1 class="text-center text-white font-weight-bold text-uppercase bg-dark" >  Web Development Quiz </h1><br>
      <div class="container "><br>
         <div class="container">


            <div class=" col-lg-8 text-center">
               <h3> <a href="#" class="text-uppercase text-warning"> <?php echo $_SESSION['username']; ?>,</a> Welcome </h3>
            </div>
            <br>
         ...
         <br>
         <footer>
            <h5 class="text-center"> &copy2019 KAJOL </h5>
         </footer>
      </div>
